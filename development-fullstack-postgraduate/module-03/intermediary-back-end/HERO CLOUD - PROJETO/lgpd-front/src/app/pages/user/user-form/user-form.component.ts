...
export class UserFormComponent {
  ...
  onSelectNewFile(event: any): void {
    ...
    // note: in the bypassSecurityTrustHtml method we are using URL
  }

  async onSubmit(fileinput: FileList | null): Promise<void> {
    // note: the parameter must include null because of the HTML

    let fileInput = fileinput![0] // fileinput is the onSubmit parameter and fileInput is the component attribute
